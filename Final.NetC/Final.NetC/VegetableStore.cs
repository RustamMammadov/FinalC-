...
namespace VegetableMarket
{
    public static class VegetableStore
    {
        ...
        }//Terevezin alish qiymeti
        public static double GetVegetableSalesPrice(VegetableAssortment vegetableAssortment)//Terevezin satish qiymeti
        {
            switch (vegetableAssortment)
            {
                case VegetableAssortment.Kelem:
        ...
        #region Terevezin defoult ratingi
        ...
        #endregion
        public static int RatingVegetable(VegetableAssortment vegetableAssortment)//Terevezin Ratingini qaytaran method
        {
            switch (vegetableAssortment)
            {
                case VegetableAssortment.Kelem:
        ...
        public static void DoIncreaseRatingVegetable(VegetableAssortment vegetableAssortment)//Terevezin ratingini artiran method
        {
            switch (vegetableAssortment)
            {
                case VegetableAssortment.Kelem:
        ...
        public static void DoDecreaseRatingVegetable(VegetableAssortment vegetableAssortment)//Terevezin ratingini azaldan method
        {
            switch (vegetableAssortment)
            {
                case VegetableAssortment.Kelem:
